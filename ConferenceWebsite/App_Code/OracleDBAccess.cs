...
namespace ConferenceWebsite.App_Code
{
    ...
    public class OracleDBAccess
    {
        ...
        private readonly OracleConnection myOracleDBConnection = new OracleConnection(ConfigurationManager.ConnectionStrings["ConferenceConnectionString"].ConnectionString);
        ...
        public bool SetData(string source, string sql, OracleTransaction trans)
        {
            bool result = false;
            try
            {
